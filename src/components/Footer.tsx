        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 eyebrow text-xs bg-stone-800 text-emerald-400 hover:bg-stone-700 px-3.5 py-2 transition-colors border border-stone-700 mb-6"
            >
              📍 Petunjuk Arah Google Maps ↗
            </a>

            <div className="pt-4 border-t border-stone-800/80">
              <h4 className="eyebrow text-stone-500 mb-3 text-[11px]">Media Sosial UNNES Giat 16</h4>
              <div className="flex flex-wrap gap-2.5">
                <a
                  href="https://www.instagram.com/giat16.desacandiyasan/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-xs bg-stone-800/90 text-stone-300 hover:text-rose-400 hover:bg-stone-800 px-3 py-1.5 rounded transition-all border border-stone-700/70"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-xs bg-stone-800/90 text-stone-300 hover:text-cyan-400 hover:bg-stone-800 px-3 py-1.5 rounded transition-all border border-stone-700/70"
                >
