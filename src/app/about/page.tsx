        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-stone-500 font-light leading-relaxed">
              Sebuah inisiatif digital untuk memberikan wadah apresiasi dan katalog eksklusif bagi setiap karya lokal dari Desa Candiyasan.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="lg:pr-12">
              ...
              <div className="space-y-6 text-stone-500 font-light text-lg leading-relaxed mb-12">
                <p>
                  Desa Candiyasan dianugerahi kekayaan intelektual dan keterampilan luar biasa dalam bidang olahan makanan, hasil pertanian, hingga kerajinan tangan. Namun, potensi ini kerap terhalang oleh keterbatasan infrastruktur digital.
                </p>
                <p>
                  Sistem inventarisasi yang terpisah-pisah dan minimnya ruang pamer (*showcase*) virtual yang pantas membuat mahakarya lokal ini sulit menjangkau panggung yang lebih luas. Katalog ini diciptakan untuk menyelesaikan kesenjangan tersebut.
                </p>
              </div>

              <h2 className="text-3xl font-serif text-stone-900 mb-8">Visi Inisiatif</h2>
              <ul className="space-y-6">
                {[
                  "Sentralisasi arsip dan data produksi ekonomi desa yang terintegrasi.",
                  "Penyediaan etalase digital yang elegan, profesional, dan eksklusif.",
                  "Peningkatan daya saing produk lokal di era modern.",
                  "Menjadi fondasi pelengkap dari sistem informasi utama Desa Candiyasan."
                ].map((item, index) => (
